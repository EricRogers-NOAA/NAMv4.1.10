...
c     (e.g., 1.00000000007), due to (I'm guessing) rounding errors.
      ...
      write (*,*) 'cosanga,degrees=',cosanga,degrees
...
!        print *,'lugb,lugi,jskp,jdisc,jids,jpdtn= ' 
!        print *, lugb,lugi,jskp,jdisc,jids,jpdtn
!        print *,'                 ' 
!        print *,'jpdt,jgdtn,jgdt,unpack,krec= ' 
!        print *, jpdt,jgdtn,jgdt,unpack,krec
