...
! !USES:
  ...
  use ensemble_fastread_commvar, only: init_ens_fast_read,ens_fast_read
...
! Initialize ens_fast_read
  call init_ens_fast_read
...
! fast ensemble read option:
  if(ens_fast_read==1) call ensemble_preread
