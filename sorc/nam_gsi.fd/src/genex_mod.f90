...
!  iasm <= ias <= iae <= iaem  ... etc.
   ...
   use kinds, only: i_kind
   use mpi, only: mpi_status_size,mpi_comm_world,mpi_integer4
   implicit none
   ...
   integer(i_kind) n,npe,mype,my_neb_l,my_neb_r
...
!$$$
   ...
   use mpi, only: mpi_status_size,mpi_comm_world,mpi_real4
   implicit none
...
!$$$
   ...
   use mpi, only: mpi_status_size,mpi_comm_world,mpi_real8
   implicit none
