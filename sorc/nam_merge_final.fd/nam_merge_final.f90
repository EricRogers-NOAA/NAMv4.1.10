...
! READ ORG PARENT DATA    ! new data
      ...
      DO J= 1, JY, 1
       P3 (1,J,KZ1) = P2(1,J,KZ1)
       Z3 (1,J,KZ1) = Z2(1,J,KZ1)
       PD3 (1,J) = PD2(1,J)
       P3 (JX,J,KZ1) = P2(JX,J,KZ1)
       Z3 (JX,J,KZ1) = Z2(JX,J,KZ1)
       PD3 (JX,J) = PD2(JX,J)
      ENDDO
      ...
      DO I= 1, JX, 1
       P3 (I,1,KZ1) = P2(I,1,KZ1)
       Z3 (I,1,KZ1) = Z2(I,1,KZ1)
       PD3 (I,1) = PD2(I,1)
       P3 (I,JY,KZ1) = P2(I,JY,KZ1)
       Z3 (I,JY,KZ1) = Z2(I,JY,KZ1)
       PD3 (I,JY) = PD2(I,JY)
      ENDDO
